...
public class NotificationDrawerSettings extends SettingsPreferenceFragment implements Indexable,
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        int smartPulldown = Settings.TESLA.getIntForUser(resolver,
                Settings.TESLA.QS_SMART_PULLDOWN, 0, UserHandle.USER_CURRENT);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mQuickPulldown) {
            ...
            Settings.TESLA.putIntForUser(resolver, Settings.TESLA.QS_SMART_PULLDOWN,
