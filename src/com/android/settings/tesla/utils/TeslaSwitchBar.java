...
* This code has been modified. Portions copyright (C) 2015 The Tesla OS.
*
...
public class TeslaSwitchBar implements SwitchBar.OnSwitchChangeListener  {
    ...
    public TeslaSwitchBar(Context context, SwitchBar switchBar, String key,
    ...
    private void setSwitchState() {
        boolean enabled = Settings.TESLA.getInt(mContext.getContentResolver(),
    ...
    public void onSwitchChanged(Switch switchView, boolean isChecked) {
        ...
        Settings.TESLA.putInt(mContext.getContentResolver(),
