...
public class TeslaListPreference extends ListPreference {
    public TeslaListPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TeslaListPreference(Context context) {
        super(context, null);
    }
